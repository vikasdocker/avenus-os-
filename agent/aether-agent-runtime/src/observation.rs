...
pub enum ObservationType {
    ...
    DisplayList { displays: serde_json::Value },
    DisplayBrightnessSet { display_id: String, level: u8 },
    DisplayResolutionSet { display_id: String, width: u32, height: u32 },
    DeviceList { devices: serde_json::Value },
    DeviceInspect { data: serde_json::Value },
    DeviceEnabled { device_id: String },
    DeviceDisabled { device_id: String },
    SystemRebootRequested { delay_ms: u64 },
    SystemShutdownRequested { delay_ms: u64 },
    SystemSuspendRequested,
    CredentialSealed { name: String },
    CredentialUnsealed { name: String, value: String },
    PolicyReloaded,
