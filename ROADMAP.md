...
| Tests                            | `cargo test --workspace` — **242 passed, 0 failed, 1 ignored** (all Rust crates; 7 new dispatch-policy tests added in 11.3; 179 tests in `aether-agentd` including the runtime e2e test).                                                                                                                                                                                                                                                                                                                                                                                |
